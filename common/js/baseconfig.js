...
const courtConfig = {
	...
	//authorization: 'Basic RGFuY2VyczpEYW5jZXJzQWRtaW4=', //(production，develop)登录Authorization
	//authNumber: 'aa8243990fb1123ff5e1336c5eda4', //(production，develop)发送验证码number
	authorization: 'Basic RGFuY2VyczI6RGFuY2Vyc0FkbWlu', //(Review)登录Authorization
	authNumber: 'aa8243990fbadawf5e1336c5eda4', //(Review)发送验证码number
	...
	// passwordRegular: /^[a-zA-Z0-9]{6}$/, //密码验证正则表达式，6-16，字母，数字，字母+数字
