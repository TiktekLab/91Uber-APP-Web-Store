		...
		<u-form :model="addStaffData" :error-type="['toast']" ref="AddStaff" class="form" label-position="top" :border-bottom="false">
			...
			<u-form-item :border-bottom="false">
				<view class="formItem padding">
					...
					<view class="priceBox padding m-radius">
						<view class="flex-space-between priceItem" v-for="(item, index) in prices" :key="index" v-if="item.type === 0">
			...
			<u-form-item :border-bottom="false">
				<view class="formItem padding">
					...
					<view class="priceBox padding m-radius">
						<view class="flex-space-between priceItem" v-for="(item, index) in prices" :key="index" v-if="item.type === 1">
							<text class="text">{{ formatTime(item.minute) }}</text>
							<view class="flex-end">
								<text class="text">$</text>
								<input class="priceInp  m-radius" v-model.number="item.price" type="number" />
